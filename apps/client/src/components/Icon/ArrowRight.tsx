...
export const ArrowRightIcon = ({ customClassName }: { customClassName?: ClassValue }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" className={clsx(base, customClassName)} height="24px" viewBox="0 -960 960 960" width="24px">
